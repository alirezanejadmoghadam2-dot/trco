...
SELF_PING_INTERVAL_SECONDS = 240         # 4 دقیقه برای بیدار ماندن
...
# ==============================================================================
# بخش ۴: حلقه اصلی ربات (بدون تست اولیه)
# ==============================================================================
async def trading_bot_loop():
    poll_seconds = SIGNAL_CHECK_INTERVAL_SECONDS; last_signal_timestamp = None
    try:
        print("\n--- 🧠 در حال آماده‌سازی داده‌ها برای استراتژی اصلی ---")
        await exchange.cancel_all_orders(SYMBOL_FOR_TRADING) # پاکسازی سفارشات قبلی
